...
Which is a strange and clarifying place to land. Acting on a preference is, in the limit, the same thing as announcing one. *How do I act without leaking* has no answer; no such policy exists. The question worth asking is *which leaks am I willing to pay for, against which audience, for how much return.*
